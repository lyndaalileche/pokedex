...
import Loading from '../loading'; // Import correct du composant Loading
import ErrorComponent from '@/app/error'; // Import correct du composant d'erreur
...
const PokemonDetailsPage: React.FC = () => {
  ...
  return (
    <div style={{ textAlign: 'center', fontSize: '20px', color: '#333', backgroundColor: '#f4f4f4', borderRadius: '10px', padding: '20px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
      ...
      <p>Types : {pokemonDetails.types.map((type) => <span style={{ backgroundColor: '#e0e0e0', borderRadius: '5px', padding: '2px 6px', marginRight: '5px' }}>{type.type.name}</span>)}</p>
      <img src={pokemonDetails.sprites.front_default} alt={`${pokemonDetails.name} sprite`} style={{ width: '200px', borderRadius: '50%', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', marginBottom: '20px' }} />
